...
ciudadano.cod_estado_judicial = estado_judicial.cod_estado_judicial AND ESTADO_JUDICIAL.cod_estado_judicial=1";
...
$pdf->Cell(60,6,'',0,1,'C');
$pdf->Cell(60,6,'',0,1,'C');
$pdf->Cell(0, 10, 'Ciudadanos requeridos por la justicia Colombiana', 0,1, 'C');
$pdf->Cell(60,6,'',0,1,'C');
$pdf->Cell(60,6,'',0,1,'C');
