      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            ...
            <li><a href="#"><i class="fa fa-circle-o"></i>Borrar Ciudadano</a></li>
          </ul>
        </li>
      </ul>
      <!-- /.sidebar-menu -->
  ...
  <div class="content-wrapper">
     <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Borrar ciudadano</h3>
            </div>
            <form method="post" action="/../SistemaDeConsultaCiudadana/views/pages/results/borradoOK.php">
            <div class="box-body">
              <strong class="identificación">Identificación</strong><input title="Este campo solo puede contener numeros" pattern="[0-9]{0,10}" maxlength="10" required="true" name="id" class="form-control" type="text" placeholder="Identificación">
              <br>
