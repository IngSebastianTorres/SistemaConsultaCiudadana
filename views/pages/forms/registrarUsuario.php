      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i>Registrar Ciudadano </a></li>
  ...
  <div class="content-wrapper">
     <div class="box box-success">
            <div class="box-header with-border">
              <h3 class="box-title">Registrar ciudadano</h3>
            </div>
            <form method="post" action="/../SistemaDeConsultaCiudadana/views/pages/results/registroOk.php">
            <div class="box-body">
              <strong class="identificación">Identificación</strong><input title="Este campo solo puede contener numeros" pattern="[0-9]{0,10}" maxlength="10" name="id" class="form-control" type="text" placeholder="Identificación" required="true">
              <br>
              <strong class="no">Nombres</strong><input title="Este campo solo puede contener letras" pattern="[A-Za-z ]{1,40}" maxlength="40" name="noms" class="form-control" type="text" placeholder="Nombres" required="true">
              <br>
              ...
              <br>
              <strong class="fen">Fecha de nacimiento</strong><input name="fena" class="form-control" type="date" placeholder="F. Nacimiento" required="true">
              <br>
              <strong class="lun">Lugar de nacimiento</strong><input title="Este campo solo puede contener letras" pattern="[A-Za-z ]{1,40}" maxlength="40" name="lugna" class="form-control" type="text" placeholder="L. Nacimiento" required="true">
              <br>
              ...
              <br>
              <strong class="nombres">Lugar de expedición</strong><input title="Este campo solo puede contener letras" pattern="[A-Za-z ]{1,40}" maxlength="40" name="lugde" class="form-control" type="text" placeholder="Lugar de expedición" required="true">
              <br>
              ...
              <select name="cej" class="form-control" required="true"> 
                  <option value="">Seleccionar</option>
