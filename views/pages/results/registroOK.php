...
<div class="wrapper">
  ...
  <div class="content-wrapper">
     <div class="box box-success">
          ...
          <tr><center><H2> Ciudadano registrado correctamente</H2></center></tr>

          </table>
          <br>
          <form action="/SistemaDeConsultaCiudadana/views/pages/forms/registrarUsuario.php">
          <center> <button type="submit" class="btn btn-warning" >Registrar otro ciudadano</button> </center>
          </form> 
    <!-- REGISTRO DE CLIENTES INI-->      
          <?php
          $identification=$_POST['id'];
          $name=$_POST['noms'];
          $lastname=$_POST['ape'];
          $fechaDeNac=$_POST['fena'];
          $lugNac=$_POST['lugna'];
          $fechaDeEx=$_POST['fede'];
          $lugarDeExp=$_POST['lugde'];
          $estatura=$_POST['est'];
          $rhh=$_POST['rh'];
          $grupoSanguineo=$_POST['gs'];
          $codEJudicial=$_POST['cej'];

          
          $sql = "INSERT INTO ciudadano VALUES ($identification, '$name', '$lastname', '$fechaDeNac', '$lugNac','$fechaDeEx','$lugarDeExp', '$estatura', '$rhh', '$grupoSanguineo', '$codEJudicial')";
