...
<div class="wrapper">
           ...
           <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <div>
                  <img src="C:/AppServ/www/SistemaDeConsultaCiudadana/imagenes/admin.png">
                </div>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
  ...
  <div class="content-wrapper">
     <div class="box box-success">
          ...
          <tr><center><H2> Ciudadano actualizado correctamente</H2></center></tr>

          </table>
          <br>
          <form action="/SistemaDeConsultaCiudadana/views/pages/forms/actualizarCiudadano.php">
          <center> <button type="submit" class="btn btn-warning" >Actulizar otro ciudadano</button> </center>
          </form> 
          ...
          $name=$_POST['name'];
          $lastname=$_POST['ape'];
          $fechaDeNac=$_POST['fecn'];
          $lugNac=$_POST['lun'];
          $fechaDeEx=$_POST['fede'];
          $lugarDeExp=$_POST['luge'];
          $estatura=$_POST['est'];
          $rhh=$_POST['rh'];
          $grupoSanguineo=$_POST['gs'];
          $codEJudicial=$_POST['code'];
          // PARA ESTE AJUSTE VALIDAR CON IF CADA CAMPO A ACTUALIZAR, Y SI NO VIENE VACIO ACTUALIZARLO
          // DE LO CONTRARIO OMITIRLO EN LAS 10 COLUMNAS POSIBLES

  
          $sql = "UPDATE ciudadano SET nombres='$name', apellidos='$lastname', fecha_de_nacimiento='$fechaDeNac', lugar_de_nacimiento ='$lugNac', fecha_de_expedicion='$fechaDeEx', lugar_de_expedicion='$lugarDeExp', estatura='$estatura', rh='$rhh', grupo_sanguineo='$grupoSanguineo', cod_estado_judicial=$codEJudicial  
