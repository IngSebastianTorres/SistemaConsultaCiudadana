...
<div class="wrapper">
  ...
  <div class="content-wrapper">
     <div class="box box-success">
          ...
          <tr><center><H2> Ciudadano eliminado correctamente</H2></center></tr>

          </table>
          <br>
          <form action="/SistemaDeConsultaCiudadana/views/pages/forms/borrarCiudadano.php">
          <center> <button type="submit" class="btn btn-warning" >Eliminar otro ciudadano</button> </center>
          </form> 
    <!-- BORRADO DE CLIENTES INI-->      
   <?php 
   $select = $_POST['id'];
   $sql = "DELETE FROM ciudadano WHERE identificacion=$select";
